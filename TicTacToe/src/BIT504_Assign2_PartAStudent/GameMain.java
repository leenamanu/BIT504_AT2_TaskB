...
public class GameMain extends JPanel implements MouseListener{
	...
	//enumeration GameState created with values Playing, Draw, Cross_won and Nought_won
	...
	public GameMain() {   
		...
		//adding the event listener so that mouse event is triggered when it is clicked on JPanel
		...
		// creating a new instance of Board class using object 'board' and calling constructor to initialize the cells
		board=new Board();
		
		//calling method to initialize Game setting all cells to empty ,first Player as Cross and game state as playing
        initGame();
	}
	...
	public static void main(String[] args) {
		...
		javax.swing.SwingUtilities.invokeLater(new Runnable() {
	         public void run() {
				...
				//creating new Game Panel and adding JFrame to the panel
	...
	public void paintComponent(Graphics g) {
		...
		if (currentState == GameState.Playing) {          
			...
			if (currentPlayer == Player.Cross) {   
				...
				//status bar updated to indicate player "X"'s turn
					statusBar.setText("X's Turn");
				
			} else {    
				
				//status bar updated to indicate player "O"'s turn
	  ...
	  /** Initialise the game-board contents and the current status of GameState and Player) */
		...
		public void updateGame(Player thePlayer, int row, int col) {
			...
			if(board.hasWon(thePlayer, row, col)) {
				...
				// if condition is used to check which player has won and set the game state according to the player who has won
				...
				// setting the game state to Draw if the game is drawn
	...
	public void mouseClicked(MouseEvent e) {  
		...
		//redraw the graphics on UI based on the cell clicked and player's turn   
